# Tecnología, política y el docente que necesitamos

**Hesus García Cobos**

Maestría en Pedagogía, UPAEP
...
## ¿Qué áreas resultan más desafiantes para el docente actual?
...
## ¿Qué componentes del traje requieren mayor desarrollo en el contexto educativo?
...
## ¿Cómo pueden las instituciones educativas apoyar la construcción de este nuevo perfil docente?
...
Apple, M. W. (2018). *Ideology and curriculum* (4a ed.). Routledge.

Consejo de Estado de la República Popular China. (2017). *Plan de desarrollo de inteligencia artificial de nueva generación* (国务院关于印发新一代人工智能发展规划的通知).

Huang, R. (2025). *Smart education: Pathways toward education 2050 (Abridged Edition)*. Smart Learning Institute, Universidad Normal de Pekín.

Kalantzis, M., y Cope, B. (2012). *New learning: Elements of a science of education* (2a ed.). Cambridge University Press.

Miao, F., Holmes, W., Huang, R., y Zhang, H. (2021). *AI and education: Guidance for policy-makers*. UNESCO.
